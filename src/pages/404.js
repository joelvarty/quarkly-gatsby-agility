...
export default (() => {
	return <Theme theme={theme}>
		...
		<Helmet>
			<title>
				Agility Website Example
			</title>
			<meta name={"description"} content={"META DESCRIPTION"} />
			<meta property={"og:title"} content={"Agility Website Example"} />
			<meta property={"og:description"} content={"OG META DESCRIPTION"} />
		...
		<RawHtml>
			<style place={"endOfHead"} rawKey={"6102fd8daa9cc700185a4845"}>
